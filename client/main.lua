			...
			local paycheckMenu = {   -- ZF_Context Menus for a cleaner look!
				{
					...
					txt = "You Have $".. paycheckdata .." To Take!" -- EDIT: I got the callback to show in the top! now you will see how much you have before withdrawing!
				},
				{
					id = 2,
...
AddEventHandler('dx-paycheck:enterAmount', function()
	ESX.TriggerServerCallback('dx-paycheck:server:GetDataMoney', function(count) -- will show how much you can withdraw!
		paycheckdata = json.decode(count)
		local dialog = exports['zf_dialog']:DialogInput({  -- ZF_Dialog for entering a said amount to withdraw!
			...
			rows = {
				{
					id = 0, 
					txt = "You Have $"..paycheckdata.." To Withdraw",  -- will let you know how much you have to withdraw!
				},
			}
		})
